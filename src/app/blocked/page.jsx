    ...
    <div className="min-h-screen bg-gradient-to-br from-[#f0f9f6] via-[#f8fcfb] to-[#eaf5f2] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        <div className="bg-white dark:bg-[#131c2b]/80 backdrop-blur-sm border border-[#d4ebe6] dark:border-[#1e293b] shadow-xl shadow-red-500/5 rounded-3xl p-8 text-center space-y-6">
          ...
          <div className="bg-[#f4f8f6] dark:bg-[#1a2435] border border-[#d4ebe6] dark:border-[#1e293b]/60 rounded-2xl p-4 text-left">
            <p className="text-xs text-[#5a7a72] dark:text-[#9fb3c8] leading-relaxed">
              <span className="font-bold text-[#1a3c34] dark:text-[#e8f4f0]">Think this is a mistake?</span>
              <br />
          ...
          <Link
            href="/"
            className="flex items-center justify-center gap-2 w-full text-[#5a7a72] dark:text-[#9fb3c8] hover:text-[#1a3c34] dark:text-[#e8f4f0] py-2 text-sm font-medium transition-colors"
          >
