...
const RegisterPage = () => {
  ...
  // Better Auth Google Sign-In (also works from register page)
  // Per spec: Google OAuth users are ALWAYS saved as Clients → redirect to Home.
        ...
        <Card className="border border-[#d4ebe6] dark:border-[#1e293b] shadow-xl shadow-[#2a9d8f]/5 bg-white dark:bg-[#131c2b]/80 backdrop-blur-sm">
          <div className="p-6 md:p-8 space-y-5">
            <div className="text-center">
              <h2 className="text-xl font-bold text-[#1a3c34] dark:text-[#e8f4f0]">Create Account</h2>
              <p className="text-[#6b8a82] dark:text-[#9fb3c8] text-sm mt-1">Join thousands of freelancers and clients</p>
            </div>
                      ...
                      className={`relative flex flex-col items-center gap-2 p-4 rounded-xl border-2 transition-all ${
                        isSelected
                          ? option.value === "freelancer"
                            ? "border-[#2a9d8f] bg-[#eaf5f2] dark:bg-[#1a2435] shadow-md shadow-[#2a9d8f]/10"
                            : "border-orange-400 bg-orange-50 shadow-md shadow-orange-200"
                          : "border-[#d4ebe6] dark:border-[#1e293b] bg-white dark:bg-[#131c2b] hover:border-[#2a9d8f]/50"
                      }`}
                    >
                      {isSelected && (
                      ...
                      <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                        isSelected
                          ...
                          : "bg-[#f0f9f6] dark:bg-[#1a2435] text-[#8aa89e] dark:text-[#6b7e94]"
                      }`}>
                        <option.icon className="w-5 h-5" />
                      </div>
                      <div className="text-center">
                        <p className={`font-semibold text-sm ${isSelected ? (option.value === "freelancer" ? "text-[#2a9d8f]" : "text-orange-500") : "text-[#1a3c34] dark:text-[#e8f4f0]"}`}>
                          {option.label}
                        </p>
                        <p className="text-xs text-[#6b8a82] dark:text-[#9fb3c8]">{option.description}</p>
                      </div>
                    </button>
                  );
                })}
